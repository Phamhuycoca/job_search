...
function init() {
    ...
    //--------------------------- Important Variables----------------------------
    botLogoPath = "/src/assets/imgs/bot-logo.png"

    //--------------------------- Chatbot Frontend -------------------------------
    const chatContainer = document.getElementById("chat-container");

    template = ` <button class='chat-btn'><img src = "/src/assets/icons/comment.png" class = "icon" style="margin:auto;" ></button>
    ...
    <div class='chat-header'>
        ...
        <!-- <span>Trợ Lý AI</span> -->
        <button class = "expand-chat-window" ><img src="/src/assets/icons/open_fullscreen.png" class="icon" ></button>
    </div>
    ...
    <div style="height: 500px; " >
		...
		<div class='chat-area'>
            <div class='bot-msg'>
				...
				<span class='msg'>Tôi có thể giúp gì được cho bạn?</span>
			</div>
...
//   }
    ...
    chatBtn.addEventListener("click", () => {
        ...
        if (chatPopup.style.display == "none" && mobileDevice) {
            ...
            chatInput.focus();
            chatBtn.innerHTML = `<img src = "/src/assets/icons/close.png" class = "icon" >`
        } else if (mobileDevice) {
            chatPopup.style.display = "none"
            chatBtn.innerHTML = `<img src = "/src/assets/icons/comment.png" class = "icon" >`
        } else {
            mobileView()
        }
    })
    ...
    expandWindow.addEventListener("click", (e) => {
        ...
        if (expandWindow.innerHTML == '<img src="/src/assets/icons/open_fullscreen.png" class="icon">') {
            expandWindow.innerHTML = `<img src = "/src/assets/icons/close_fullscreen.png" class = 'icon'>`
            root.style.setProperty('--chat-window-height', 80 + "%");
            root.style.setProperty('--chat-window-total-width', 85 + "%");
        } else if (expandWindow.innerHTML == '<img src="/src/assets/icons/close.png" class="icon">') {
            chatPopup.style.display = "none"
            chatBtn.style.display = "block"
        } else {
            expandWindow.innerHTML = `<img src = "/src/assets/icons/open_fullscreen.png" class = "icon" >`
...
function mobileView() {
    ...
    if (chatPopup.style.display == "none") {
        ...
        chatPopup.style.right = "3"
            // chatPopup.style.transition = "none"
        expandWindow.innerHTML = `<img src = "/src/assets/icons/close.png" class = "icon" >`
    }
}
