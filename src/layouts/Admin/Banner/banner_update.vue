                    ...
                    <el-col :span="24">
                        <div class="w-full flex justify-center mb-5">
                            <img v-if="selectedImage" :src="selectedImage" alt="Selected Image"
                                class="w-96 h-96 border border-inherit" />
                        ...
                        <div class="w-full flex justify-center h-1/6">
                            <el-button color="red" v-if="selectedImage" :icon="Edit" plain @click="onRemoveImage">Xoá
                                ảnh</el-button>
                        </div>
                    </el-col>
                </el-row>
...
const { update, getData } = useBanner();
const bannerId = ref('');
const onRemoveImage = () => {
...
const getDetail = async (id: any) => {
    ...
    selectedImage.value = res.data.bannerPath;
    bannerId.value = res.data.bannerId;
}
...
const saveData = async () => {
    ...
    const res = await update(formData, bannerId.value);
    if (res.success) {
