                        ...
                        <div class="max-w-40 max-h-40">
                            <label for="file" class="labelFile flex items-center justify-center">
                                <div v-if="imageData" class="image-container" @mouseover="showButton = true"
                                    ...
                                    <img class="max-w-40 max-h-40" v-if="imageData" :src="imageData"
                                        alt="Uploaded Image">
                                    <button v-if="showButton" class="centered-button" @click="deleteImage">Xóa
                                        ảnh</button>
                                </div>
                                <div v-else>
                                    <span><svg xml:space="preserve" viewBox="0 0 184.69 184.69"
                            ...
                            <div v-for="(inputExp, index) in inputExps" :key="index" class="relative mt-3">
                                <el-row class="mt-3">
                                    <el-col :span="7" class="pt-4">
                                        <input v-model="inputExp.name" class="border-none bg-transparent outline-none"
                                            type="text" placeholder="Tên kĩ năng...">
                                    </el-col>
                                    <el-col :span="17">
